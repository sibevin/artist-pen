...
import { FeatureConfig } from "~/dwdy/feature/text/def";
import SvgIcon from "~/components/SvgIcon.vue";

const dwdyState = useDwdyState();
const featureConfig = ref<FeatureConfig>(
  dwdyState.diary.value.fetchFeatureConfig(DiaryFeature.Text)
);
...
async function onConfigUpdated(
  ...
  dwdyState.diary.value.patchFeatureConfig(DiaryFeature.Text, givenConfig);
